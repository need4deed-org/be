...
export class AddAppreciationEntity1768420185221 implements MigrationInterface {
  name = "AddAppreciationEntity1768420185221";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."appreciation_title_enum" AS ENUM('called', 'tried-to-call', 'texted-or-emailed', 'other')`,
    );
    await queryRunner.query(
      `CREATE TABLE "appreciation" ("id" SERIAL NOT NULL, "title" "public"."appreciation_title_enum" NOT NULL, "date_due" TIMESTAMP, "date_delivery" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "opportunity_id" integer, "volunteer_id" integer, "user_id" integer, CONSTRAINT "PK_d9824c8e198e82f7394c805eddf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
